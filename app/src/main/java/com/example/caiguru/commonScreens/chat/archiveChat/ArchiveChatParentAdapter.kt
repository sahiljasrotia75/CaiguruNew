...
class ArchiveChatParentAdapter(var context: Context) : RecyclerView.Adapter<ArchiveChatParentAdapter.ViewHolder>() {
    ...
    private fun setChatAdapter(
        ...
        val mChatAdapter = ArchiveChatAdapter(context)
