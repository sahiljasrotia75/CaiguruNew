...
class OtherProfileLatestReviewsAdapter(
    var context: Context

) : RecyclerView.Adapter<OtherProfileLatestReviewsAdapter.ViewHolder>() {

    private lateinit var dialogs: Dialog
    private lateinit var list: ReviewsModel
