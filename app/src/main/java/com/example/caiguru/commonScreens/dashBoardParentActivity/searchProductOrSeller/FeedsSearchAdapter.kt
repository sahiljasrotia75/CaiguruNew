...
import kotlinx.android.synthetic.main.dcreiption_alert_dialog.*
...
class FeedsSearchAdapter(var context: Context) :
    RecyclerView.Adapter<FeedsSearchAdapter.ViewHolder>() {
    private var adressModel = AddAddressModel()
    private var getProfileModel = GetProfileModel()
    private var hasLiked: Boolean = false
    private lateinit var adapter: FeedSearchChildAdapter
    var mData: ArrayList<HomeModel> = ArrayList()
    var listner = context as setLikeInterface
...
//                holder.itemView.onlyCashButton.visibility = View.GONE
//                for (item in paymentMethods) {
//                    if (item == "1") {
//                        holder.itemView.cashlogo.visibility = View.VISIBLE
//                    } else {
...
//            }else{
//                for (item in paymentMethods) {
//                    holder.itemView.cashlogo.visibility = View.GONE
//                    if (item == "1") {
//                        holder.itemView.creditDebit.visibility = View.GONE
//                        holder.itemView.onlyCashButton.visibility = View.VISIBLE
//                    } else  {
//                        holder.itemView.onlyCashButton.visibility = View.GONE
//                        holder.itemView.creditDebit.visibility = View.VISIBLE
//                    }
       ...
       // }
        ...
        if (model.is_buy_btn_show == "1") {
            ...
            if (model.is_processing == "1") {
                ...
                holder.itemView.purchase.isClickable = false
                holder.itemView.purchase.isEnabled = false
            } else {
            ...
            holder.itemView.purchase.visibility = View.GONE
...
//                            true
        ...
        adapter = FeedSearchChildAdapter(context)
