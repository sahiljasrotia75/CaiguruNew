...
class FeedSearchChildAdapter(var context: Context) :
    RecyclerView.Adapter<FeedSearchChildAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (model.highlight=="1") {
            holder.itemView.allLayoutHome.setBackgroundColor(Color.parseColor("#330066"))
            holder.itemView.productPrice.setTextColor(Color.parseColor("#ffbf00"))
            holder.itemView.productUnit.setTextColor(Color.parseColor("#ffbf00"))
            holder.itemView.productName.setTextColor(Color.parseColor("#ffbf00"))
            holder.itemView.productImage.background=context.getDrawable(R.drawable.buyer_home_product_curve_rectangle)
        } else {
            holder.itemView.allLayoutHome.setBackgroundColor(Color.parseColor("#f2efe5"))
            holder.itemView.productPrice.setTextColor(Color.parseColor("#330066"))
            holder.itemView.productUnit.setTextColor(Color.parseColor("#666666"))
            holder.itemView.productImage.background=context.getDrawable(R.drawable.buyer_home_product_curve_rectangle)
            holder.itemView.productName.setTextColor(Color.parseColor("#666666"))
        }
