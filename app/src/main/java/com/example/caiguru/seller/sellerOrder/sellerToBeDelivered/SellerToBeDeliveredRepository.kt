...
class SellerToBeDeliveredRepository(var application: Application) {
    var mSucessfulPendingApproval = MutableLiveData<ArrayList<SellerApprovalModel>>()
    var mFailure = MutableLiveData<String>()
    val modelDataArray=ArrayList<SellerApprovalModel>()
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                try {
                    ...
                    if (status == "true") {
                        ...
                        modelDataArray.addAll(modelData)
                        mSucessfulPendingApproval.value = modelDataArray
