...
class CancelledOrderParentAdapter(var context: SellerCancelledOrderListActivity) :
    RecyclerView.Adapter<CancelledOrderParentAdapter.Viewholder>() {
    private lateinit var recyclerAdapter: CancelledOrderChildAdapter
    ...
    override fun onBindViewHolder(holder: Viewholder, position: Int) {
       ...
       // holder.itemView.txtCategories.text = CategoryMatching(data.cat_id)
        ...
        //......child adapter..........//
        recyclerAdapter = CancelledOrderChildAdapter(context)
