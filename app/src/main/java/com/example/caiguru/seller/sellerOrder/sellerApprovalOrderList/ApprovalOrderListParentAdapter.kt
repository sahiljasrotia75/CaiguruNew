...
class ApprovalOrderListParentAdapter(var context: SellerApprovalOrderListActivity) :
    RecyclerView.Adapter<ApprovalOrderListParentAdapter.Viewholder>() {
    private lateinit var recyclerAdapter: ApprovalOrderListChildAdapter
    ...
    override fun onBindViewHolder(holder: Viewholder, position: Int) {
        ...
        holder.itemView.txtshoppingListt.visibility=View.GONE
        ...
        //......child adapter..........//
        recyclerAdapter = ApprovalOrderListChildAdapter(context)
