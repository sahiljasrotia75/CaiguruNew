...
class PayCreditSingleListDeliveryDetailsAdapter(var context: PayCreditsSingleListActivity) :
    RecyclerView.Adapter<PayCreditSingleListDeliveryDetailsAdapter.Viewholder>() {
