...
class BuyerDeliveredRepository(var application: Application) {
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                try {
                    ...
                    if (status == "true") {
                        ...
                        val gson = Gson()
                        val modelData: ArrayList<FinalizeModel> = gson.fromJson(
                            requests, object : TypeToken<ArrayList<FinalizeModel>>() {}.type
                        )
